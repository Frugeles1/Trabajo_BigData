...
# Cabe destacar que de la informacion recopilada. 
# "Nombre" son los nombres de los animes recopilados.
# "Episodios" es la cantidad de episodios que contiene cada anime.
# "Resumen" es la descripcion de cada anime. 
# "Talternativo" es el titulo con el que tambien se pueden encontrar, la mayoria de ellos son de donde se emiten. 
# "Creadores" son quienes escribieron la obra o manga en un comienzo.
# "Directores" son quienes estan a cargo del proyecto respecto a la animacion del anime. 
# "Estreno" es la fecha en la que el anime fue emitido. 
# "Estado" entrega informacion respecto a si la emision del anime finalizo, se realizara o esta en ello.
# "Temporadas" muestra cuantas temporadas tiene el anime en general, independiente si no son continuas en todo sentido.
